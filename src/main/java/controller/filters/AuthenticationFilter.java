...
public class AuthenticationFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
	    ...
	    if(uri.endsWith(StringUtils.PAGE_URL_INDEX) || uri.endsWith("/")) {
...
//	        res.sendRedirect(req.getContextPath() + StringUtils.SERVLET_URL_HOME);
	    ...
	    } else if (!isLoggedIn && (uri.endsWith("contact.jsp") || (uri.endsWith("order.jsp") || uri.endsWith("specification.jsp")))) {
	    	 res.sendRedirect(req.getContextPath() + StringUtils.PAGE_URL_INDEX);
	    } else {
