...
public class RegisterStudentServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) 
		...
		LocalDate dob = LocalDate.parse(request.getParameter(StringUtils.DATE_OF_BIRTH));
		...
		// Create a UserModel object to hold student information
		UserModel user = new UserModel(username, dob, gender, email, phoneNumber, location, password, imagePart);
		
		
		// Implement data validation here (e.g., check for empty fields, email format,
		// etc.)
//		if(!ValidationUtil.isAlphanumeric(username) || !ValidationUtil.isEmail(email) || !ValidationUtil.isNumbersOnly(phoneNumber) || !ValidationUtil.isGenderMatches(gender)) {
//		
